...
class SquadDetailsScraper(SeleniumScraper):
    ...
    def __init__(self):
        ...
        self.SQUAD_DETAILS_LOCATION = os.getenv("SQUAD_DETAILS_LOCATION")
        self.get_old_seasons_data()
    pass

    def get_season_link(self, season):
        """ Generate the FBref URL for a given season. """
        return f"https://fbref.com/en/squads/add600ae/{season}-{season+1}/c8"
